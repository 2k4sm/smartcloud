  ...
  return (
    <div className="max-w-4xl space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <h1 className="font-mono text-2xl font-semibold tracking-tight">{pool.name}</h1>
          {pool.description && (
      ...
      <Card className="gap-0 overflow-hidden py-0">
        <CardHeader className="border-b py-3">
          <CardTitle className="text-sm">Keys in pool</CardTitle>
        </CardHeader>
        {keys.length === 0 ? (
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center gap-2 text-sm">
              ...
              <Input
                ...
                className="h-8 w-20"
              />
              <span className="text-muted-foreground">days (blank = off)</span>
            </div>
            <p className="text-xs text-muted-foreground">
              Rotation switches the served key to the least-used active one. All keys
              stay valid.
            </p>
          </CardContent>
        </Card>
