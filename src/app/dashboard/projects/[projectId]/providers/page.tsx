...
export default async function ProvidersPage({ params }: Props) {
  ...
  return (
    <div>
      ...
      <h1 className="text-3xl font-bold text-white mt-2 mb-1 tracking-tight">Cloud providers</h1>
      <p className="text-gray-400 text-sm mb-8">
        Sync secrets in <span className="text-gray-200">{project.name}</span> out
        to AWS, Azure, or GCP.
      </p>
